...
Route::get('/', function () {
    ...
    $links = "https%3A%2F%2Fnilamufti.vercel.app%2F%3Fown%3D$own%26to%3D$namaonUrl%0A";

    $url = $link1 . $nomor . $link2 . $nama . $link3 . $links . $link4;
